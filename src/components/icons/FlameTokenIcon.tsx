...
const FLAME_RED = "#ea580c";
const FLAME_YELLOW = "#fbbf24";
const FLAME_TIP = "#fef3c7";
...
export default function FlameTokenIcon({ className }: FlameTokenIconProps) {
  return (
    ...
    >
      {/* Coin body */}
      <circle cx="12" cy="12" r="10" fill={FLAME_ORANGE} fillOpacity="0.12" stroke="currentColor" strokeWidth="1.5" />
      {/* Inner ring */}
