...
/** Faint top-edge glow color per stat category — used on prop cards. */
export const CATEGORY_GLOW_COLORS: Record<StatCategory, string> = {
  points: "from-orange-500/20",
  rebounds: "from-blue-500/20",
  assists: "from-green-500/20",
  threes: "from-purple-500/20",
  blocks: "from-red-500/20",
  steals: "from-yellow-500/20",
  turnovers: "from-gray-500/15",
  pra: "from-pink-500/20",
  pts_reb: "from-teal-500/20",
  pts_ast: "from-lime-500/20",
  reb_ast: "from-cyan-500/20",
  blk_stl: "from-rose-500/20",
  shots: "from-orange-500/20",
  shots_on_target: "from-red-500/20",
  tackles: "from-yellow-500/20",
  passes: "from-blue-500/20",
  goals: "from-green-500/20",
  fouls_committed: "from-gray-500/15",
  saves: "from-purple-500/20",
  hits: "from-sky-500/20",
  home_runs: "from-amber-500/20",
  rbis: "from-indigo-500/20",
  runs: "from-emerald-500/20",
  stolen_bases: "from-fuchsia-500/20",
  total_bases: "from-violet-500/20",
  pitcher_strikeouts: "from-rose-500/20",
  pitcher_outs: "from-slate-500/20",
  hits_runs_rbis: "from-teal-500/20",
};
